...
## 
## - `cdecls <cdecl/cdecl/cdecls.html>`_: Macros to help using C macros that declare variables
##   - `cdeclmacro`
## - `applies <cdecl/cdecl/applies.html>`_: Macros that unpack arguments from various forms and calls functions
...
## - `bitfields <cdecl/cdecl/bitfields.html>`_: Macros for making bitfield style accessor 
